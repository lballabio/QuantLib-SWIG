...
SWIG_STD_VECTOR_ENHANCED( QuantLib::ext::shared_ptr<StochasticProcess> )
#endif
%template(StochasticProcessVector)
std::vector<QuantLib::ext::shared_ptr<StochasticProcess> >;
...
#if defined(SWIGCSHARP)
SWIG_STD_VECTOR_ENHANCED( QuantLib::ext::shared_ptr<StochasticProcess1D> )
#endif
%template(StochasticProcess1DVector)
std::vector<QuantLib::ext::shared_ptr<StochasticProcess1D> >;
...
class StochasticProcessArray : public StochasticProcess {
  public:
      StochasticProcessArray(
               const std::vector<QuantLib::ext::shared_ptr<StochasticProcess1D> >&array,
...
%inline %{
    const QuantLib::ext::shared_ptr<GsrProcess> as_gsr_process(
                           const QuantLib::ext::shared_ptr<StochasticProcess>& proc) {
        return QuantLib::ext::dynamic_pointer_cast<GsrProcess>(proc);
    }
%}
...
class ExtendedOrnsteinUhlenbeckProcess : public StochasticProcess1D {
    public:
        ...
        ExtendedOrnsteinUhlenbeckProcess(
                                ...
                                const QuantLib::ext::function<Real (Real)>& b,
...
class ExtOUWithJumpsProcess : public StochasticProcess {
    public:
        ExtOUWithJumpsProcess(
            const QuantLib::ext::shared_ptr<ExtendedOrnsteinUhlenbeckProcess>& process,
...
class KlugeExtOUProcess : public StochasticProcess {
    public:
        KlugeExtOUProcess(
            Real rho,
            const QuantLib::ext::shared_ptr<ExtOUWithJumpsProcess>& kluge,
            const QuantLib::ext::shared_ptr<ExtendedOrnsteinUhlenbeckProcess>& extOU) {
