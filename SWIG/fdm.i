...
SWIG_STD_VECTOR_ENHANCED( QuantLib::ext::shared_ptr<Fdm1dMesher> )
#endif
namespace std {
    %template(Fdm1dMesherVector) vector<QuantLib::ext::shared_ptr<Fdm1dMesher> >;
}
...
class FdmBlackScholesMesher : public Fdm1dMesher {
  public:
    ...
    FdmBlackScholesMesher(
        ...
        const std::vector<QuantLib::ext::shared_ptr<Dividend> >& dividendSchedule
            = std::vector<QuantLib::ext::shared_ptr<Dividend> >(),
        const QuantLib::ext::shared_ptr<FdmQuantoHelper>& fdmQuantoHelper
            = QuantLib::ext::shared_ptr<FdmQuantoHelper>(),
        Real spotAdjustment = 0.0);

    static QuantLib::ext::shared_ptr<GeneralizedBlackScholesProcess> processHelper(
...
%template(Concentrating1dMesherPoint) QuantLib::ext::tuple<Real, Real, bool>;
%template(Concentrating1dMesherPointVector) std::vector<QuantLib::ext::tuple<Real, Real, bool> >;
...
class FdmHestonVarianceMesher : public Fdm1dMesher {
  public:
    FdmHestonVarianceMesher(
        Size size,
        const QuantLib::ext::shared_ptr<HestonProcess> & process,
...
class FdmSimpleProcess1dMesher : public Fdm1dMesher {
  public:
      FdmSimpleProcess1dMesher(
        Size size,
        const QuantLib::ext::shared_ptr<StochasticProcess1D>& process,
        Time maturity, Size tAvgSteps = 10, Real epsilon = 0.0001,
...
class FdmMesherComposite : public FdmMesher {
  public:
    FdmMesherComposite(
        const QuantLib::ext::shared_ptr<FdmLinearOpLayout>& layout,
        const std::vector<QuantLib::ext::shared_ptr<Fdm1dMesher> > & mesher);

    // convenient constructors
    explicit FdmMesherComposite(
        const std::vector<QuantLib::ext::shared_ptr<Fdm1dMesher> > & mesher);
    explicit FdmMesherComposite(
        const QuantLib::ext::shared_ptr<Fdm1dMesher>& mesher);
    FdmMesherComposite(const QuantLib::ext::shared_ptr<Fdm1dMesher>& m1,
                       const QuantLib::ext::shared_ptr<Fdm1dMesher>& m2);
    FdmMesherComposite(const QuantLib::ext::shared_ptr<Fdm1dMesher>& m1,
                       const QuantLib::ext::shared_ptr<Fdm1dMesher>& m2,
                       const QuantLib::ext::shared_ptr<Fdm1dMesher>& m3);
    FdmMesherComposite(const QuantLib::ext::shared_ptr<Fdm1dMesher>& m1,
                       const QuantLib::ext::shared_ptr<Fdm1dMesher>& m2,
                       const QuantLib::ext::shared_ptr<Fdm1dMesher>& m3,
                       const QuantLib::ext::shared_ptr<Fdm1dMesher>& m4);
    ...
    %extend {
        ...
        QuantLib::ext::shared_ptr<FdmLinearOpLayout> layout() {
            const std::vector<QuantLib::ext::shared_ptr<Fdm1dMesher> >& meshers =
            ...
            return QuantLib::ext::make_shared<FdmLinearOpLayout>(dim);
        }
    }

    const std::vector<QuantLib::ext::shared_ptr<Fdm1dMesher> >&
...
typedef std::vector<QuantLib::ext::shared_ptr<FdmBoundaryCondition> > FdmBoundaryConditionSet;
%}
...
#if defined(SWIGCSHARP)
SWIG_STD_VECTOR_ENHANCED( QuantLib::ext::shared_ptr<FdmBoundaryCondition> )
#endif

%template(FdmBoundaryConditionSet) std::vector<QuantLib::ext::shared_ptr<FdmBoundaryCondition> >;
...
class FdmDirichletBoundary : public FdmBoundaryCondition {
  public:
    ...
    FdmDirichletBoundary(const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
...
class FdmDiscountDirichletBoundary : public FdmBoundaryCondition {
  public:
    ...
    FdmDiscountDirichletBoundary(
        const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
  ...
  public:
    ...
    %extend {
        ...
        FdmTimeDepDirichletBoundary(
            ...
            const QuantLib::ext::function<Real(Real)> f = UnaryFunction(function);
...
class FdmBatesOp : public FdmLinearOpComposite {
  public:
    FdmBatesOp(
        const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
        const QuantLib::ext::shared_ptr<BatesProcess>& batesProcess,
...
class Fdm2dBlackScholesOp : public FdmLinearOpComposite {
  public:  
    Fdm2dBlackScholesOp( 
        const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
        const QuantLib::ext::shared_ptr<GeneralizedBlackScholesProcess>& p1,
        const QuantLib::ext::shared_ptr<GeneralizedBlackScholesProcess>& p2,
        Real correlation,
        Time maturity,
        bool localVol = false,
        doubleOrNull illegalLocalVolOverwrite = -Null<Real>());
...
class FdmG2Op : public FdmLinearOpComposite {
  public:
    FdmG2Op(
        const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
        const QuantLib::ext::shared_ptr<G2>& model,
...
class FdmHestonHullWhiteOp : public FdmLinearOpComposite {
  public:
    FdmHestonHullWhiteOp(
        const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
        const QuantLib::ext::shared_ptr<HestonProcess>& hestonProcess,
        const QuantLib::ext::shared_ptr<HullWhiteProcess>& hwProcess,
...
class FdmHullWhiteOp : public FdmLinearOpComposite {
  public:
    FdmHullWhiteOp(
        const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
        const QuantLib::ext::shared_ptr<HullWhite>& model,
        Size direction);
};
...
class FdmLocalVolFwdOp : public FdmLinearOpComposite {
  public:
      FdmLocalVolFwdOp(
        const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
        const QuantLib::ext::shared_ptr<Quote>& spot,
        const QuantLib::ext::shared_ptr<YieldTermStructure>& rTS,
        const QuantLib::ext::shared_ptr<YieldTermStructure>& qTS,
...
class FdmOrnsteinUhlenbeckOp : public FdmLinearOpComposite {
  public:
    FdmOrnsteinUhlenbeckOp(
        const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
        const QuantLib::ext::shared_ptr<OrnsteinUhlenbeckProcess>& p,
        const QuantLib::ext::shared_ptr<YieldTermStructure>& rTS,
        Size direction = 0);
};
...
class CraigSneydScheme  {
  public:
    CraigSneydScheme(Real theta, Real mu,
        const QuantLib::ext::shared_ptr<FdmLinearOpComposite> & map,
...
class FdmLogInnerValue : public FdmCellAveragingInnerValue {
  public:
    FdmLogInnerValue(const QuantLib::ext::shared_ptr<Payoff>& payoff,
                     const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
                     Size direction);
};
...
class FdmLogBasketInnerValue : public FdmInnerValueCalculator {
  public:
    FdmLogBasketInnerValue(const QuantLib::ext::shared_ptr<BasketPayoff>& payoff,
                           const QuantLib::ext::shared_ptr<FdmMesher>& mesher);
};
  ...
  public:
    ...
    %extend {
        FdmAffineModelSwapInnerValue(
            const QuantLib::ext::shared_ptr<ModelType>& disModel,
            const QuantLib::ext::shared_ptr<ModelType>& fwdModel,
            const QuantLib::ext::shared_ptr<VanillaSwap>& swap,
...
#if defined(SWIGCSHARP)
SWIG_STD_VECTOR_ENHANCED( QuantLib::ext::shared_ptr<StepCondition<Array> > )
#endif

%template(FdmStepConditionVector) std::vector<QuantLib::ext::shared_ptr<StepCondition<Array> > > ;
 
%shared_ptr(FdmStepConditionComposite)
class FdmStepConditionComposite : public StepCondition<Array> {
public:
    typedef std::vector<QuantLib::ext::shared_ptr<StepCondition<Array> > > Conditions;
    %extend {
        FdmStepConditionComposite(
            const std::vector<Time> & stoppingTimes,
            const std::vector<QuantLib::ext::shared_ptr<StepCondition<Array> > > & conditions) {
            return new FdmStepConditionComposite(
                std::list<std::vector<Time> >(1, stoppingTimes), 
                std::list<QuantLib::ext::shared_ptr<StepCondition<Array> > >(
                    conditions.begin(), conditions.end()));
        }
    }

    const std::vector<Time>& stoppingTimes() const;
    const std::vector<QuantLib::ext::shared_ptr<StepCondition<Array> > > & conditions() const;

    static QuantLib::ext::shared_ptr<FdmStepConditionComposite> joinConditions(
                const QuantLib::ext::shared_ptr<FdmSnapshotCondition>& c1,
                const QuantLib::ext::shared_ptr<FdmStepConditionComposite>& c2);

    static QuantLib::ext::shared_ptr<FdmStepConditionComposite> vanillaComposite(
         const std::vector<QuantLib::ext::shared_ptr<Dividend> >& schedule,
         const QuantLib::ext::shared_ptr<Exercise>& exercise,
         const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
         const QuantLib::ext::shared_ptr<FdmInnerValueCalculator>& calculator,
         const Date& refDate,
...
class FdmDividendHandler : public StepCondition<Array> {
  public:
    FdmDividendHandler(const std::vector<QuantLib::ext::shared_ptr<Dividend> >& schedule,
                       const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
                       const Date& referenceDate,
                       const DayCounter& dayCounter,
                       Size equityDirection);
  ...
  public:
    %extend {
        FdmSolverDesc(
            const QuantLib::ext::shared_ptr<FdmMesher>& mesher,
            const FdmBoundaryConditionSet& bcSet,
            const QuantLib::ext::shared_ptr<FdmStepConditionComposite>& condition,
            const QuantLib::ext::shared_ptr<FdmInnerValueCalculator>& calculator,
            Time maturity,
            Size timeSteps,
            Size dampingSteps) {
        ...
        QuantLib::ext::shared_ptr<FdmMesher> getMesher() const { return self->mesher; }
        const FdmBoundaryConditionSet& getBcSet() const { return self->bcSet; }
        QuantLib::ext::shared_ptr<FdmStepConditionComposite> 
            getStepConditions() const { return self->condition; }
        QuantLib::ext::shared_ptr<FdmInnerValueCalculator> 
...
class Fdm1DimSolver {
  public:
    Fdm1DimSolver(const FdmSolverDesc& solverDesc,
                  ...
                  const QuantLib::ext::shared_ptr<FdmLinearOpComposite>& op);
...
class FdmIndicesOnBoundary {
  public:
    FdmIndicesOnBoundary(const QuantLib::ext::shared_ptr<FdmLinearOpLayout>& l,
...
%feature("kwargs") LocalVolRNDCalculator;
    ...
    QuantLib::ext::shared_ptr<Fdm1dMesher> mesher(Time t) const;
    %extend {
