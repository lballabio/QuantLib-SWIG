...
class ConvertibleZeroCouponBond : public Bond {
  public:
    ConvertibleZeroCouponBond(
          ...
          const std::vector<QuantLib::ext::shared_ptr<Dividend> >& dividends,
          const std::vector<QuantLib::ext::shared_ptr<Callability> >& callability,
...
class BinomialConvertibleEngine : public PricingEngine {
  public:
    BinomialConvertibleEngine(const QuantLib::ext::shared_ptr<GeneralizedBlackScholesProcess>&,
                              Size steps);
};
