...
class SwapRateHelper : public RateHelper {
  public:
    ...
    SwapRateHelper(
            ...
            Date customPillarDate = Date());
    Spread spread();
    QuantLib::ext::shared_ptr<VanillaSwap> swap();
};
...
class BondHelper : public RateHelper {
  public:
    ...
    QuantLib::ext::shared_ptr<Bond> bond();
};
...
class FixedRateBondHelper : public BondHelper {
  public:
    ...
    QuantLib::ext::shared_ptr<FixedRateBond> fixedRateBond();
};
...
class OISRateHelper : public RateHelper {
  ...
  public:
    OISRateHelper(
            ...
            Pillar::Choice pillar = Pillar::LastRelevantDate,
            Date customPillarDate = Date());
    QuantLib::ext::shared_ptr<OvernightIndexedSwap> swap();
};
...
SWIG_STD_VECTOR_ENHANCED( QuantLib::ext::shared_ptr<RateHelper> )
#endif
namespace std {
    %template(RateHelperVector) vector<QuantLib::ext::shared_ptr<RateHelper> >;
}

// allow use of RateHelper vectors
#if defined(SWIGCSHARP)
SWIG_STD_VECTOR_ENHANCED( QuantLib::ext::shared_ptr<BondHelper> )
#endif
namespace std {
    %template(BondHelperVector) vector<QuantLib::ext::shared_ptr<BondHelper> >;
}

%inline %{
    const QuantLib::ext::shared_ptr<DepositRateHelper> as_depositratehelper(const QuantLib::ext::shared_ptr<RateHelper> helper) {
        return QuantLib::ext::dynamic_pointer_cast<DepositRateHelper>(helper);
    }
	const QuantLib::ext::shared_ptr<FraRateHelper> as_fraratehelper(const QuantLib::ext::shared_ptr<RateHelper> helper) {
        return QuantLib::ext::dynamic_pointer_cast<FraRateHelper>(helper);
    }
    const QuantLib::ext::shared_ptr<SwapRateHelper> as_swapratehelper(const QuantLib::ext::shared_ptr<RateHelper> helper) {
        return QuantLib::ext::dynamic_pointer_cast<SwapRateHelper>(helper);
    }
    const QuantLib::ext::shared_ptr<OISRateHelper> as_oisratehelper(const QuantLib::ext::shared_ptr<RateHelper> helper) {
        return QuantLib::ext::dynamic_pointer_cast<OISRateHelper>(helper);
    }
%}
