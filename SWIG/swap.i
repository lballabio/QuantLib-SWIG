...
class Swap : public Instrument {
  public:
    Swap(const std::vector<QuantLib::ext::shared_ptr<CashFlow> >& firstLeg,
         const std::vector<QuantLib::ext::shared_ptr<CashFlow> >& secondLeg);
    Date startDate();
    Date maturityDate();
...
class MakeVanillaSwap {
      public:
        ...
        %extend{
            QuantLib::ext::shared_ptr<VanillaSwap> makeVanillaSwap(){
                return (QuantLib::ext::shared_ptr<VanillaSwap>)(* $self);
            }
        }
};
...
class FloatFloatSwap : public Swap {
  public:
    FloatFloatSwap(VanillaSwap::Type type, const std::vector<Real> &nominal1,
        ...
        const QuantLib::ext::shared_ptr<InterestRateIndex> &index1,
        const DayCounter &dayCount1, const Schedule &schedule2,
        const QuantLib::ext::shared_ptr<InterestRateIndex> &index2,
...
class MakeOIS {
      public:
        ...
        %extend{
            QuantLib::ext::shared_ptr<OvernightIndexedSwap> makeOIS(){
                return (QuantLib::ext::shared_ptr<OvernightIndexedSwap>)(* $self);
            }
        }
...
class OvernightIndexedSwapIndex : public SwapIndex {
  public:
    ...
    */
    QuantLib::ext::shared_ptr<OvernightIndexedSwap> underlyingSwap(
                                            const Date& fixingDate) const;
};

%inline %{
    QuantLib::ext::shared_ptr<OvernightIndexedSwap> as_overnight_swap_index(
                          const QuantLib::ext::shared_ptr<InterestRateIndex>& index) {
        return QuantLib::ext::dynamic_pointer_cast<OvernightIndexedSwap>(index);
    }
%}
