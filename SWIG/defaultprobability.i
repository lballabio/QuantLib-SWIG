...
SWIG_STD_VECTOR_ENHANCED( QuantLib::ext::shared_ptr<DefaultProbabilityHelper> )
#endif
namespace std {
  ...
  public:
    %extend {
        Name(const Date& referenceDate,
             const std::vector<QuantLib::ext::shared_ptr<DefaultProbabilityHelper> >& instruments,
             const DayCounter& dayCounter,
