...
class BlackCalibrationHelper : public CalibrationHelper {
  public:
    ...
    void setPricingEngine(const QuantLib::ext::shared_ptr<PricingEngine>& engine);
...
%inline %{
    QuantLib::ext::shared_ptr<BlackCalibrationHelper> as_black_helper(const QuantLib::ext::shared_ptr<CalibrationHelper>& h) {
        return QuantLib::ext::dynamic_pointer_cast<BlackCalibrationHelper>(h);
    }
    QuantLib::ext::shared_ptr<SwaptionHelper> as_swaption_helper(const QuantLib::ext::shared_ptr<BlackCalibrationHelper>& h) {
        return QuantLib::ext::dynamic_pointer_cast<SwaptionHelper>(h);
    }
%}
...
class SwaptionHelper : public BlackCalibrationHelper {
  public:
    ...
    QuantLib::ext::shared_ptr<VanillaSwap> underlyingSwap() const;
    QuantLib::ext::shared_ptr<Swaption> swaption() const;
...
SWIG_STD_VECTOR_ENHANCED( QuantLib::ext::shared_ptr<CalibrationHelper> )
SWIG_STD_VECTOR_ENHANCED( QuantLib::ext::shared_ptr<BlackCalibrationHelper> )
#endif
namespace std {
    %template(CalibrationHelperVector)
        vector<QuantLib::ext::shared_ptr<CalibrationHelper> >;
    %template(BlackCalibrationHelperVector)
        vector<QuantLib::ext::shared_ptr<BlackCalibrationHelper> >;
}
