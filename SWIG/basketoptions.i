...
class MinBasketPayoff : public BasketPayoff  {
  public:
    MinBasketPayoff(const QuantLib::ext::shared_ptr<Payoff> p);
};

%shared_ptr(MaxBasketPayoff)
class MaxBasketPayoff : public BasketPayoff  {
  public:
    MaxBasketPayoff(const QuantLib::ext::shared_ptr<Payoff> p);
};
...
class AverageBasketPayoff :
      public BasketPayoff  {
  public:
    AverageBasketPayoff(const QuantLib::ext::shared_ptr<Payoff> p,
                           const Array &a);
    AverageBasketPayoff(const QuantLib::ext::shared_ptr<Payoff> p,
                           Size n);
};
...
class SpreadBasketPayoff : public BasketPayoff  {
  public:
    SpreadBasketPayoff(const QuantLib::ext::shared_ptr<Payoff> p);
};
...
class BasketOption : public MultiAssetOption {
  public:
    BasketOption(
            const QuantLib::ext::shared_ptr<BasketPayoff>& payoff,
...
class MCEuropeanBasketEngine : public PricingEngine {
  ...
  public:
    %extend {
        MCEuropeanBasketEngine(const QuantLib::ext::shared_ptr<StochasticProcessArray>& process,
...
class MCAmericanBasketEngine : public PricingEngine {
  ...
  public:
    %extend {
        MCAmericanBasketEngine(const QuantLib::ext::shared_ptr<StochasticProcessArray>& process,
                               intOrNull timeSteps = Null<Size>(),
                               intOrNull timeStepsPerYear = Null<Size>(),
                               bool brownianBridge = false,
                               bool antitheticVariate = false,
...
class StulzEngine : public PricingEngine {
  public:
    StulzEngine(const QuantLib::ext::shared_ptr<GeneralizedBlackScholesProcess>& process1,
...
class KirkEngine : public PricingEngine {
  public:
    KirkEngine(const QuantLib::ext::shared_ptr<BlackProcess>& process1,
...
class Fd2dBlackScholesVanillaEngine : public PricingEngine {
  public:
    Fd2dBlackScholesVanillaEngine(const QuantLib::ext::shared_ptr<GeneralizedBlackScholesProcess>& p1,
...
class MCEverestEngine : public PricingEngine {
  ...
  public:
    %extend {
        MCEverestEngine(const QuantLib::ext::shared_ptr<StochasticProcessArray>& process,
...
class MCHimalayaEngine : public PricingEngine {
  ...
  public:
    %extend {
        MCHimalayaEngine(const QuantLib::ext::shared_ptr<StochasticProcessArray>& process,
                         bool brownianBridge = false,
                         bool antitheticVariate = false,
                         intOrNull requiredSamples = Null<Size>(),
                         doubleOrNull requiredTolerance = Null<Real>(),
