...
class Cap : public CapFloor {
  public:
    Cap(const std::vector<QuantLib::ext::shared_ptr<CashFlow> >& leg,
           const std::vector<Rate>& capRates);
};
...
class Floor : public CapFloor {
  public:
    Floor(const std::vector<QuantLib::ext::shared_ptr<CashFlow> >& leg,
             const std::vector<Rate>& floorRates);
};
...
class Collar : public CapFloor {
  public:
    Collar(const std::vector<QuantLib::ext::shared_ptr<CashFlow> >& leg,
              const std::vector<Rate>& capRates,
              const std::vector<Rate>& floorRates);
};
